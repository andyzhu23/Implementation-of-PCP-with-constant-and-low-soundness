...
std::vector<std::function<void()>> test_cases = {
    ...
    []() -> void {
        ...
        pcp::BinaryCSP amplified_pcp = core::three_color_gap_amplification(input, pcpp::TesterType::HADAMARD);
        analyzer::PCPAnalyzer analyzer_original({{BinaryCSP, false}}, 10000);
    ...
    []() -> void {
        ...
        pcp::BinaryCSP BinaryCSP = input.to_BinaryCSP(pcpp::TesterType::HADAMARD);
        pcp::BinaryCSP amplified_pcp = core::three_color_gap_amplification(input, pcpp::TesterType::HADAMARD);
        analyzer::PCPAnalyzer analyzer_original({{BinaryCSP, false}}, 100000);
        std::cout << "Original PCP size: " << BinaryCSP.get_size() << std::endl;
        std::cout << "Original PCP completeness: " << analyzer_original.getCompleteness() << std::endl;
        std::cout << "Original PCP soundness: " << analyzer_original.getSoundness() << std::endl;
        std::cout << "Original PCP gap: " << analyzer_original.getGap() << std::endl;
    ...
    []() -> void {
        ...
        pcp::BinaryCSP BinaryCSP = input.to_BinaryCSP(pcpp::TesterType::HADAMARD);
        pcp::BinaryCSP amplified_pcp = core::three_color_gap_amplification(input, pcpp::TesterType::HADAMARD);
        analyzer::PCPAnalyzer analyzer_original({{BinaryCSP, false}}, 20000);
    ...
    []() -> void {
        ...
        pcp::BinaryCSP BinaryCSP = input.to_BinaryCSP(pcpp::TesterType::HADAMARD);
        pcp::BinaryCSP amplified_pcp = core::three_color_gap_amplification(input, pcpp::TesterType::HADAMARD);
        analyzer::PCPAnalyzer analyzer_original({{BinaryCSP, false}}, 30000);
    ...
    []() -> void {
        ...
        pcp::BinaryCSP BinaryCSP = input.to_BinaryCSP(pcpp::TesterType::HADAMARD);
        pcp::BinaryCSP amplified_pcp = core::three_color_gap_amplification(input, pcpp::TesterType::HADAMARD);
        analyzer::PCPAnalyzer analyzer_original({{BinaryCSP, false}}, 50000);
    ...
    []() -> void {
        ...
        pcp::BinaryCSP BinaryCSP = input.to_BinaryCSP(pcpp::TesterType::HADAMARD);
        pcp::BinaryCSP amplified_pcp = core::three_color_gap_amplification(input, pcpp::TesterType::HADAMARD);
        analyzer::PCPAnalyzer analyzer_original({{BinaryCSP, false}}, 40000);
