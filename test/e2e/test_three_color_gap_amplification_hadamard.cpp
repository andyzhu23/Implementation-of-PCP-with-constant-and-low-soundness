...
std::vector<std::function<void(std::ofstream&)>> test_cases = {
    [](std::ofstream &fout) -> void {
        ...
        pcp::BinaryCSP amplified_pcp = core::three_color_gap_amplification(input, pcpp::TesterType::HADAMARD, test_iteration_func);
...
int main() {
    std::ofstream fout("../results/test_three_color_gap_amplification_hadamard_result.txt");
    fout << "Running test_three_color_gap_amplification_hadamard.cpp" << std::endl;
