...
void test_case_1() {
    std::vector<three_col::Color> values { Color::RED, Color::GREEN, Color::BLUE, Color::RED };
    std::vector<csp::Constraint<three_col::Color>> constraints {
        {0, 1, not_equal},
        {1, 2, not_equal},
        {2, 3, not_equal},
    };
...
void test_case_3() {
    ...
    std::vector<Constraint<Color>> constraints { };
    CSP<2, Color> p(1, values, constraints);
    auto r = get_radius_nodes(p, 0, 5);
    assert(r.size() == 1);
